...
<p>
    <a href="{{ route('kategoripemasukan.create') }}" class="btn btn-sm btn-primary input" title="Create Kategori Pemasukan">Create</a>
</p>
@endif
            ...
            @foreach ($data as $datas)
                <tr>
                    ...
                    <td class="text-center">
                        <a href="{{ route('kategoripemasukan.edit',['id' => $datas['id']]) }}" class="btn btn-sm btn-primary input" title="Edit Kategori Pemasukan">Ubah</a>
                    </td>
                    @endif
                    @if(\App\Models\User::find(session()->get('sesiuserid'))->GroupUser->Module()->where('route',Route::currentRouteName())->first()->pivot->hapus == 'Y')
                    <td class="text-center">
                        <a href="{{ route('kategoripemasukan.delete',['id' => $datas['id']]) }}" class="btn btn-sm btn-danger input" title="Delete Kategori Pemasukan">Hapus</a>
                    </td>
                    @endif
                </tr>
            @endforeach
