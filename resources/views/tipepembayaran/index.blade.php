...
<p>
    <a href="{{ route('tipepembayaran.create') }}" class="btn btn-sm btn-primary input" title="Create Tipe Pembayaran">Create</a>
</p>
@endif
            ...
            @foreach ($data as $datas)
                <tr>
                    ...
                    <td class="text-center">
                        <a href="{{ route('tipepembayaran.edit',['id' => $datas['id']]) }}" class="btn btn-sm btn-primary input" title="Edit Tipe Pembayaran">Ubah</a>
                    </td>
                    @endif
                    @if(\App\Models\User::find(session()->get('sesiuserid'))->GroupUser->Module()->where('route',Route::currentRouteName())->first()->pivot->hapus == 'Y')
                    <td class="text-center">
                        <a href="{{ route('tipepembayaran.delete',['id' => $datas['id']]) }}" class="btn btn-sm btn-danger input" title="Delete Tipe Pembayaran">Hapus</a>
                    </td>
                    @endif
                </tr>
            @endforeach
